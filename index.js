...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let descriptionInput=document.querySelector("#agent-description").value;
    let nameInput=document.querySelector("#agent-name-input").value;
    let typeInput=document.querySelector("#agent-type-select").value;
